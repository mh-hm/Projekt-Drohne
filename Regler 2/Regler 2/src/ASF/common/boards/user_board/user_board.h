...
#define PDCA_IRQ_NR				AVR32_PDCA_IRQ_1
...
#define RTC						&AVR32_AST
#define RTC_SELECTED_CLOCK		AVR32_AST_CSSEL_PBCLOCK
#define RTC_PRESCALER			17
#define RTC_PIR0_PRESCALSER		5
#define RTC_IRQ_LEVEL			1
#define RTC_IRQ_NR				AVR32_AST_PER_IRQ
#define RTC_IRQ_GROUP			AVR32_AST_IRQ_GROUP1
